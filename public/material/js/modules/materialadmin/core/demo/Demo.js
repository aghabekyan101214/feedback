(function (namespace, $) {
	...
	p._handleChatMessage = function (e) {
		...
		if (e.keyCode === 13) {
			...
			var thread = $('#sidebarChatMessage').attr('data-id');
			var message = input.val();
			userSend(message,thread);
			...
			html += '<li>';
			html += '	<div class="chat">';
			html += '		<div class="chat-avatar"><i style="font-size: 40px" class="md md-headset-mic img-circle"></i></div>';
