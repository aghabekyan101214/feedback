                                    ...
                                    @foreach($employees as $bin => $e)
                                        <tr>
                                            ...
                                            <td class="button-column">
                                                <a rel="tooltip" data-toggle="tooltip" title="" href="/admin/employees/{{ $e->id }}" data-original-title="View">
                                                    <button class="btn btn-icon-toggle"><i class="fa fa-street-view"></i></button>
                                                </a>
                                                <a rel="tooltip" data-toggle="tooltip" title="" href="/admin/employees/{{ $e->id }}/edit" data-original-title="Update">
                                                    <button class="btn btn-icon-toggle"><i class="fa fa-edit"></i></button></a>
                                                <form onsubmit="if(confirm('Do You Really Want To Delete The Question?') == false) return false;" style="display: inline-block" action="/admin/employees/{{ $e->id }}" method="post">
                                                    @csrf
                                                    @method("DELETE")
