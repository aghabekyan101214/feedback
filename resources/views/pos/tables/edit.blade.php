    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel">
                ...
                <form action="{{ $route."/".$table->id }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-8">
                                        <select name="section_id" class="form-control" id="">
                                            ...
                                            @foreach($sections as $section)
                                                <option @if($table->sections->id == $section->id) selected @endif value="{{ $section->id }}">{{ $section->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
